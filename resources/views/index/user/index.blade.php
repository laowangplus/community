            ...
            <div class="layui-tab layui-tab-brief" lay-filter="user">
                ...
                <div class="layui-tab-content" style="padding: 20px 0;">
                    <div class="layui-tab-item layui-show">
                        <form class="layui-form" method="post" action="" style="margin-bottom: 10px">
                            <div class="layui-input-inline">
                                <input type="text" name="article_title" placeholder="请输入标题"
                                       autocomplete="off" class="layui-input" value="{{Session::get('article_title')}}">
                            </div>

                            <div class="layui-input-inline">
                                <input type="month" name="article_month"
                                       autocomplete="off" class="layui-input" value="{{Session::get('article_month')}}">
                            </div>
                            ...
                            <div class="layui-input-inline">
                                <select name="article_category">
                                    ...
                                    @foreach($categorys as $category)
                                        @if($category->id == Session::get('article_category'))
                        ...
                        <ul class="mine-view jie-row" id="article">
