            ...
            <form action="{{ url('login') }}" method="post">
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                  <input type="email" id="L_email" name="email" value="415813765@qq.com" required lay-verify="required" autocomplete="off" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                  <input type="text" id="L_vercode" name="vercode" value="1111" required lay-verify="required" placeholder="请输入正确验证码" autocomplete="off" class="layui-input">
                </div>
