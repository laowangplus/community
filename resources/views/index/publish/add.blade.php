                ...
                <div class="layui-tab layui-tab-brief" lay-filter="user">
                    ...
                    <div class="layui-form layui-tab-content" id="LAY_ucm" style="padding: 20px 0;">
                        ...
                        <div class="layui-form-item layui-form-text">
                            <div id="toolbar" class="toolbar" style="border: 1px solid #ccc; width: auto">
                            </div>
                            ...
                            <div class="layui-inline">
                                ...
                                <div id="L_label" class="layui-input-inline" style="width: auto; border: 1px solid #e6e6e6; height: 36px">
                                    ...
                                    <div class="tagsinput-primary form-group">
                                        <input name="tag" id="tagsinputval" class="tagsinput" data-role="tagsinput" value="" placeholder="输入后回车">
                                    </div>
                                </div>
                            </div>
                        </div>
